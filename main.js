tema0=['#21b0fe','#fed700','#fe218b',0];
tema1=['#2b2d42','#8d99ae','#edf2f4',200];
tema2=['#f6f7eb','#e94f37','#393e41',0];
tema3=['#0038a8','#d60270','#9b4f96',255];
tema4=['#000000','#14213d','#fca311',255];
tema5=['#8cb369','#f4e285','#f4a259',0];
tema7=['#e6af2e','#e0e2db','#191716',0];
tema6=[100,0,255,0]

boje=[tema0,tema1,tema2,tema3,tema6,tema5,tema4,tema7];
